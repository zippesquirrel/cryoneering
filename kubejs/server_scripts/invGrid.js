...
ServerEvents.tags('item', event => {
    const groups = {
        onebythree: [/immersiveengineering:.*post/],
        twobythree: [/immersiveengineering:blastfurnace_preheater/,
            ...
            /immersiveengineering:current_transformer/,/(?!<trap)door/],
        onebytwo: [/immersiveengineering:hammer$/,/chain$/,/curtain$/,/banner$/,/linemans_stick$/,/tall_stool/,/electrical_panel/,/hexafluoride_breaker/],
        twobyone: [/slab$/, /carpet$/, /ice_layer$/, /sleet_layer$/, /^marbledsfirstaid:medical_bag$/,
            ...
            /immersiveengineering:railgun$/,/immersiveengineering:chemthrower$/,/basin_lid/],
        one: [/button$/,/lever/,/candle$/,/sea_pickle$/,/kelp$/,
            ...
            /energetics.*sign/,/linked_receiver$/,/microphone$/,/radio$/,/computercraft:cable$/,],
        two: [/large_tire$/,/boat$/,/hearth/],
        three: [/create:large_water_wheel/,/monstrous_tire$/,
                /.*large_(?!metal_(?!cogwheel)).*((cogwheel)|(fan))/,/.*crushing_wheel$/],
        threebyone: [/sleeping_bag/,/hammock/],
        threebytwo: [/_bed$/, /^marbledsfirstaid:medkit$/,/radiosmither$/,/huge_diesel_engine/],
        four: [/immersiveengineering:watermill/]
    }
...
ServerEvents.loaded(event => {
  // Runs the server command silently when scripts load/reload
  event.server.runCommand('savaruinv reload')
})